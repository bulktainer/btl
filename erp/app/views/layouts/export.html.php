...
<html lang="en">
  <head>
    ...
    <link href="<?php echo HOME; ?>css/erp/grid-0.5.6.min.css" rel="stylesheet" />
  ...
  <body>
    ...
    <div id="footer" class="container_12 topborder">
      <div class="grid_6">Copyright &copy; 2011 Bulk Tainer Logistics</div>
    ...
    <script src="<?php echo HOME; ?>js/erp/vendor/grid-0.5.6.min.js"></script>
