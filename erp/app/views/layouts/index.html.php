...
<html lang="en">
  <head>
    ...
    <link href="<?php echo HOME; ?>css/jquery-ui-1.7.3.custom.css" rel="stylesheet" />
    ...
    <link href="<?php echo HOME; ?>css/erp/starter-template.css" rel="stylesheet" />
    <link href="<?php echo HOME; ?>css/erp/chosen.min.css" rel="stylesheet" />
    <link href="<?php echo HOME . BTL_BASE_CSS; ?>" rel="stylesheet" />
    <link href="<?php echo HOME; ?>css/erp/scratch.css" rel="stylesheet" />
    <link href="//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css"
      rel="stylesheet" />
    <link href="<?php echo HOME; ?>css/bootstrap-multiselect.css" rel="stylesheet" />
  ...
  <body>
    ...
    <div id="content" class="container_12 container rounded <?php echo $class == 'supplier-costs' ? 'custom-container' : ''; ?>">
      <div class="grid_12">
        <?php if(!empty($errors)) : ?>
    ...
    <script src="<?php echo HOME; ?>js/erp/vendor/jquery-ui-1.10.4.custom.min.js"></script>
    <script src="<?php echo HOME; ?>js/erp/vendor/jquery.tablesorter.min.js"></script>
    <script src="<?php echo HOME; ?>js/erp/vendor/jquery.tablesorter.widgets.min.js"></script>
    <script src="<?php echo HOME; ?>js/erp/vendor/jquery.tablesorter.pager.min.js"></script>
    ...
    <script src="<?php echo HOME; ?>js/erp/functions.js"></script>
    <script src="<?php echo HOME; ?>js/erp/suppliers.js"></script>
    <script src="<?php echo HOME; ?>js/erp/customer-quotes.js"></script>
    <script src="<?php echo HOME; ?>js/erp/supplier-costs.js"></script>
    <script src="<?php echo HOME; ?>js/erp/deep-sea.js"></script>
    <script src="<?php echo HOME; ?>js/time-out.js"></script>
    <script src="<?php echo HOME; ?>js/bootstrap-multiselect.js"></script>
