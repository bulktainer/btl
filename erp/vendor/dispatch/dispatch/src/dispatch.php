...
/**
 * Created by Digital Mesh on 29-June-2016
 * Same as above but it won't add '_' symbol before the page
 */
function custom_partial($view, $locals = null) {
	$path = basename($view);
	$view = preg_replace('/'.$path.'$/', "{$path}", $view);
	return template($view, $locals);
}
